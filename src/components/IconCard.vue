...
div(class="w-full sm:w-1/4 md:w-1/5 xl:w-1/6")
  div(class="m-2")
    div(class="relative flex-shrink-0 flex flex-col justify-center items-center w-full h-40 text-gray-800 hover:text-white bg-white hover:bg-indigo-500 rounded shadow hover:shadow-lg hover:z-30 transition duration-150 ease-in-out"  @click="doCopy")
      .w-5.h-5
