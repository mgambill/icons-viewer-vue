...
div
  ...
  .container.mx-auto(class="md:px-3 xl:px-0") 
    .mt-1.relative.rounded-md.shadow-sm
      ...
      input#filter(class='form-input block w-full pl-10 pr-12 sm:text-sm sm:leading-5'  placeholder='Search icons' v-model="filterText")
    ...
    div.text-sm.py-8.mt-3.flex.justify-between
      div.flex
        ...
        a.text-indigo-600(href="https://github.com/mgambill/heroicons-viewer-vue/" target="_blank" rel="noreferrer" class='hover:underline') heroicons-viewer-vue  
      div
        | Viewer inspired by  
        a.text-indigo-600(href="https://heroicons-viewer.netlify.com/" target="_blank" rel="noreferrer" class='hover:underline') Zaydek Michels-Gualtieri 
        span.emoji 👋      
</template>
